...
> Status: 1.1.0 — stable. Production-ready packaging
...
```bash
# Debian / Ubuntu (.deb)
sudo apt install ./anima-engine_1.1.0-1_amd64.deb

# AppImage (any distro)
chmod +x animaEngine-1.1.0-x86_64.AppImage
./animaEngine-1.1.0-x86_64.AppImage
