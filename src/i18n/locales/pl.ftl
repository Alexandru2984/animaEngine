...
scene-window-awareness-unavailable = Niedostępne w natywnym Waylandzie — żaden protokół nie udostępnia pozycji okien.
...
appearance-language-no-font = Brak zainstalowanej czcionki dla tego pisma — zainstaluj najpierw pakiet Noto CJK.
theme-dark = Ciemny
theme-light = Jasny
